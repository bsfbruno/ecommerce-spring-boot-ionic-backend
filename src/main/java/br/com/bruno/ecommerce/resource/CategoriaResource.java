...
import br.com.bruno.ecommerce.service.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<Void> inserir(@Valid /*faz o json ser conv. para java*/@RequestBody CategoriaDTO objDTO) {
