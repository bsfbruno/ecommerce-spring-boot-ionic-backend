...
import br.com.bruno.ecommerce.service.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<Void> inserir(@Valid /*faz o json ser conv. para java*/@RequestBody ClienteNewDTO objDTO) {
